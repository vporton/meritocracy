...
- Bootstrap/deployer authority is distinct from DAO/controller authority. Its revocation is durable: the G2/M2 upgrade proof must demonstrate revoke → upgrade → authorization checks, with the intended DAO authority still present and the revoked bootstrap grant still absent.
