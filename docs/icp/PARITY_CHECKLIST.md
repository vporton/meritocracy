...
| FE-009 | `/treasury` reserve/distribution/funding interface | Certified public accounting projection plus wallet-driven deposits; never expose signing secrets | DESIGNED / BLOCKED_G3 |
