...
for artifact in treasury_lost_reply_authority.wasm treasury_lost_reply_treasury.wasm treasury_lost_reply_archive.wasm treasury_lost_reply_transfer.wasm SHA256SUMS; do
...
node "$repo_root/scripts/icp/treasury-payment-operation-lost-reply-pocketic-proof.cjs" "$runtime_bin" "$artifact_dir/treasury_lost_reply_authority.wasm" "$artifact_dir/treasury_lost_reply_treasury.wasm" "$artifact_dir/treasury_lost_reply_archive.wasm" "$artifact_dir/treasury_lost_reply_transfer.wasm"
