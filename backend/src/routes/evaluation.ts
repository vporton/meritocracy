...
import { requireAuth, requireKYC, requireAdditionalConnections } from '../middleware/auth.js';
 ...
 */
router.post('/start', requireAuth, requireKYC, requireAdditionalConnections, async (req, res) => {
  try {
