...
/// Private fixed persistence boundary for workflow completion receipts. It
/// stores only a bounded immutable identity and recovery tuple: no workflow
/// payload, task input, provider response, or caller identity crosses this
/// boundary.
module {
