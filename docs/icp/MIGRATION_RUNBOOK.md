...
- A sensitive identity/KYC projection cannot enter staging until G2 records its purpose/data controller/legal basis, minimization, encryption/key-access boundary, retention/cryptographic-erasure deadline, backup/restore behavior, access-audit role, and accounting/anti-evasion exception. Missing policy is a blocking exception; it does not justify retaining unrestricted evidence. The owner-approved G2 policy input allows only verified display legal name, caller principal, payout addresses, payment history, and evaluation history in a certified public projection, subject to that projection's field allowlist; it does not permit raw social identifiers or unrestricted record publication. Published treasury receiving configuration is separate.
