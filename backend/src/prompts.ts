...
export const onboardingPrompt = `Is the person identified by the input a scientist or FOSS dev with substantive, attributable public science writing or software output?
Do not require that this work was published within any fixed recent time window: people may pause work while retaining their eligibility for payments.
Answer no, if he/she is an obvious science crackpot in his/her field.
However, answer yes even if he/she is a hobbyist, provided the substantive-work requirement is satisfied.
...
Set failureCategory to NOT_ACTIVE_OR_WRITER for other rejections such as no substantive attributable science or software output.
